            ...
            <div className="support-wrapper">
                <div className="support-container">
                    <form className="support-card" onSubmit={handleSubmit}>
                        <h2>Keluhan Masyarakat</h2>
                        <input type="text" placeholder="Masukkan Nama" value={nama} onChange={(e) => setNama(e.target.value)} required />
                        <input type="text" placeholder="Masukkan judul keluhan" value={judul} onChange={(e) => setJudul(e.target.value)} required />
                        ...
                        <input className="description-text" type="text" placeholder="Masukkan isi keluhan" value={isi} onChange={(e) => setIsi(e.target.value)} required />
