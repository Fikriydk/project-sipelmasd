            ...
            <div className="support-wrapper">
                <div className="support-container">
                    <form className="support-card" onSubmit={handleSubmit}>
                        ...
                        <input type="text" placeholder="Masukkan judul pengaduan" value={judul} onChange={(e) => setJudul(e.target.value)} required />
                        ...
                        <input className="description-text" type="text" placeholder="Masukkan isi pengaduan" value={isi} onChange={(e) => setIsi(e.target.value)} required />
